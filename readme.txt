...
Mobilize adds a swipe menu to any site, when the width is lower than 720.

Read more here:
http://getbutterfly.com/wordpress-plugins/mobilize/
...
4. Assign a menu to the "Mobilize Navigation" section in Appearance -> Menus
